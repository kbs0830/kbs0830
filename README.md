...
| 専案 | 技術棧 | 說明 |
|------|--------|------|
| 🔍 **Food Vision Analyzer** | YOLOv8 · Gemini AI · ONNX | 影像留本機的隱私優先食品辨識，薄客戶端架構 |
| 💹 **Exchange Rate Engine** | Flask · SQLite · Yahoo Finance | 多銀行並行爬蟲 + 購買力決策引擎 |
...
### `> watch ./contribution.svg`

<div align="center">

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/kbs0830/kbs0830/output/snake-dark.svg" />
  <img src="https://raw.githubusercontent.com/kbs0830/kbs0830/output/snake.svg" alt="contribution snake animation" />
</picture>
